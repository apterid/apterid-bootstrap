...
using Apterid.Apterid_LanguageService;

namespace Apterid.LanguageService_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new Apterid_LanguageServicePackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Apterid.Apterid_LanguageService.GuidList.guidApterid_LanguageServiceCmdSet, (int)Apterid.Apterid_LanguageService.PkgCmdIDList.cmdidInsertSnippet);
